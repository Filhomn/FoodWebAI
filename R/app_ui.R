...
(management, political, etc.) or as scientific evidence.</b><br><br>
                    ...
                    selectInput(
                      ...
                      choices = c(
                        'GPT 3.5 (Fast - Medium Quality)' = 'gpt-3.5-turbo-instruct',
                        'GPT 5.2 (Very Slow - Good Quality)' = 'gpt-5.2',
                        'GPT 5.4 (Slow - Good Quality)' = 'gpt-5.4',
                        'GPT 5.4 nano (Fast - Medium Quality)' = 'gpt-5.4-nano'
                      ),
                      selected = c('gpt-3.5-turbo-instruct')
...
<div style='text-align: justify; margin: 0 auto; max-width: 600px;'>
        ...
        tags$div(
          ...
          tags$div(
            ...
            tags$div(
              br(),
              br(),
              HTML("<div id='authors' class='uk-card uk-card-default uk-card-hover uk-card-body'>
    <h6 class='uk-card-title'><center></center></h6>

    <article id='author1' class='uk-comment uk-comment-primary'>
        <header class='uk-comment-header'>
            <div class='uk-grid-medium uk-flex-middle' uk-grid>
                <div class='uk-width-auto'>
                    <img class='uk-comment-avatar' src='www/assets/4.png' width='100' height='100' alt=''>
                </div>
                <div class='uk-width-expand'>
                    <h4 class='uk-comment-title uk-margin-remove'><a class='uk-link-reset' href='#'>Dr. Noleto-Filho, Eurico</a></h4>
                    <ul class='uk-comment-meta uk-subnav uk-subnav-divider uk-margin-remove-top'>
                        <li style='font-size: 16px;'>Researcher and Data Scientist</li>
                        <li><a href='https://www.researchgate.net/profile/Eurico-Mesquita-Noleto-Filho' style='font-size: 14px;'>ResearchGate Profile</a></li>
                    </ul>
                    <h5>Project contribution: App Development, Research Concept and Application.</h5>
                </div>
            </div>
        </header>
    </article>
    ...
    <br>
    <article id='author2' class='uk-comment uk-comment-primary'>
        <header class='uk-comment-header'>
            <div class='uk-grid-medium uk-flex-middle' uk-grid>
                <div class='uk-width-auto'>
                    <img class='uk-comment-avatar' src='www/assets/5.png' width='95' height='95' alt=''>
                </div>
                <div class='uk-width-expand'>
                    <h4 class='uk-comment-title uk-margin-remove'><a class='uk-link-reset' href='#'>Dr. Ronaldo Angelini</a></h4>
                    <ul class='uk-comment-meta uk-subnav uk-subnav-divider uk-margin-remove-top'>
                        <li style='font-size: 16px;'>Researcher - Universidade Federal do Rio Grande do Norte, Brazil</li>
                        <li><a href='https://www.researchgate.net/profile/Ronaldo-Angelini-2' style='font-size: 14px;'>ResearchGate Profile</a></li>
                    </ul>
                    <h5>Project contribution: Research Concept and Application.</h5>
                </div>
            </div>
        </header>
    </article>
    ...
    <br>
    <article id='author3' class='uk-comment uk-comment-primary'>
        <header class='uk-comment-header'>
            <div class='uk-grid-medium uk-flex-middle' uk-grid>
                <div class='uk-width-auto'>
                    <img class='uk-comment-avatar' src='www/assets/1.png' width='100' height='100' alt=''>
                </div>
                <div class='uk-width-expand'>
                    <h4 class='uk-comment-title uk-margin-remove'><a class='uk-link-reset' href='#'>Dr. Tommaso Giarrizzo</a></h4>
                    <ul class='uk-comment-meta uk-subnav uk-subnav-divider uk-margin-remove-top'>
                        <li style='font-size: 16px;'>Researcher - Universidade Federal do Ceará, Brazil</li>
                        <li><a href='https://www.researchgate.net/profile/Tommaso-Giarrizzo-2' style='font-size: 14px;'>ResearchGate Profile</a></li>
                    </ul>
                    <h5>Project contribution: Research Concept and Application.</h5>
                </div>
            </div>
    ...
    <br>
    <article id='author4' class='uk-comment uk-comment-primary'>
        <header class='uk-comment-header'>
            <div class='uk-grid-medium uk-flex-middle' uk-grid>
                <div class='uk-width-expand'>
                    <h4 class='uk-comment-title uk-margin-remove'><a class='uk-link-reset' href='#'>Dr. Marta Coll</a></h4>
                    <ul class='uk-comment-meta uk-subnav uk-subnav-divider uk-margin-remove-top'>
                        <li style='font-size: 16px;'>Researcher - Institute of Marine Science (ICM–CSIC) (Barcelona, Spain)</li>
                        <li><a href='https://martacollmarine.science' style='font-size: 14px;'>Profile</a></li>
                    </ul>
                    <h5>Project contribution: Research Concept and Application.</h5>
                </div>
            </div>
    ...
    <br>
    <article id='author5' class='uk-comment uk-comment-primary'>
        <header class='uk-comment-header'>
            <div class='uk-grid-medium uk-flex-middle' uk-grid>
                <div class='uk-width-expand'>
                    <h4 class='uk-comment-title uk-margin-remove'><a class='uk-link-reset' href='#'>Dr. Jeroen Steenbeek</a></h4>
                    <ul class='uk-comment-meta uk-subnav uk-subnav-divider uk-margin-remove-top'>
                        <li style='font-size: 16px;'>Researcher - Ecopath International Initiative</li>
                        <li><a href='https://www.researchgate.net/profile/Jeroen-Steenbeek' style='font-size: 14px;'>ResearchGate Profile</a></li>
                    </ul>
                    <h5>Project contribution: Research Concept and Application.</h5>
                </div>
            </div>
    ...
    <br>
    <article id='author6' class='uk-comment uk-comment-primary'>
        <header class='uk-comment-header'>
            <div class='uk-grid-medium uk-flex-middle' uk-grid>
                <div class='uk-width-auto'>
                    <img class='uk-comment-avatar' src='www/assets/IMG_7964.png' width='100' height='100' alt=''>
                </div>
                <div class='uk-width-expand'>
                    <h4 class='uk-comment-title uk-margin-remove'><a class='uk-link-reset' href='#'>Dr. Friedrich Keppeler</a></h4>
                    <ul class='uk-comment-meta uk-subnav uk-subnav-divider uk-margin-remove-top'>
                        <li style='font-size: 16px;'>Researcher - Universidade Federal do Pará, Brazil</li>
                        <li><a href='https://www.researchgate.net/profile/Friedrich-Wolfgang-Keppeler-2' style='font-size: 14px;'>ResearchGate Profile</a></li>
                    </ul>
                    <h5>Project contribution: Research Concept and Application.</h5>
                </div>
            </div>
    ...
    <br>
    <article id='author7' class='uk-comment uk-comment-primary'>
        <header class='uk-comment-header'>
            <div class='uk-grid-medium uk-flex-middle' uk-grid>
                <div class='uk-width-auto'>
                    <img class='uk-comment-avatar' src='www/assets/IMG_7963.png' width='100' height='100' alt=''>
                </div>
                <div class='uk-width-expand'>
                    <h4 class='uk-comment-title uk-margin-remove'><a class='uk-link-reset' href='#'>Dr. José Amorim Reis-Filho</a></h4>
                    <ul class='uk-comment-meta uk-subnav uk-subnav-divider uk-margin-remove-top'>
                        <li style='font-size: 16px;'>Researcher - Universidade Federal do Pará, Brazil</li>
                        <li><a href='https://www.researchgate.net/profile/Jose-Reis-Filho' style='font-size: 14px;'>ResearchGate Profile</a></li>
                    </ul>
                    <h5>Project contribution: Research Concept and Application.</h5>
                </div>
            </div>
